...
namespace Yang.CSharp.Notes.Exercises.MyHashtable
{
    #region 练习题一
    ...
    /// </summary>
    internal class MonsterMgr
    {
        private readonly Hashtable monstersTable = new();
        ...
        public static MonsterMgr Instance { get; } = new();
    ...
    internal class NotesExercises_Hashtable
    {

...
namespace Yang.CSharp.Notes.Exercises
{
    ...
    internal class SingleBase<T> where T : new()
    {
        public static T Instance { get; } = new();
    }

    internal class GameMgr : SingleBase<GameMgr>
    {
        public int value = 10;
    }

    internal class Test : SingleBase<Test>
    {
        public int value = 10;
    }
    ...
    internal class Test2
    {
        ...
        public static Test2 Instance { get; } = new();
    }
    ...
    internal class ArrayList<T>
    {
        ...
        public void RemoveAt(int index)
        {
            ...
            //后面的往前放
            for (; index < Count - 1; index++) array[index] = array[index + 1];
    ...
    internal class NotesExercises_GenericConstraints
    {

...
namespace Yang.CSharp.Notes.Exercises.List
{
    internal class NotesExercises_List
    {
        private static void Main(string[] args)
        {
            ...
            for (int i = 0; i < Monster.monsters.Count; i++) Monster.monsters[i].Atk();

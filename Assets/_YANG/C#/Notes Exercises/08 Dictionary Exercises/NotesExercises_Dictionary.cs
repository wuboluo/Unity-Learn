...
{
    internal class NotesExercises_Dictionary
    {
        private static void Main(string[] args)
        {
            ...
            foreach (char item in dic.Keys) Console.WriteLine("字母{0}出现了{1}次", item, dic[item]);

            #endregion
        }

        private static string GetInfo(int num)
        {

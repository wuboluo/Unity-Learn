...
namespace Yang.CSharp.Notes.Exercises
{
    ...
    internal class Monster
    {
        ...
        {
            return string.Format("怪物信息-血量{0}攻击力{1}防御力{2}", hp, atk, def);
        }
    }
    ...
    internal class NotesExercises_ListSort
    {
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("*********************");
            for (int i = 0; i < 10; i++) Console.WriteLine(itemList[i]);
            ...
            for (int i = 0; i < list.Count; i++) Console.WriteLine(list[i].Key + "_" + list[i].Value);
        }

        private static int SortFun(Monster m1, Monster m2)
        {

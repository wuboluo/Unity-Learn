...
public class CSharp_8_PatternMatchingPro : MonoBehaviour
{
    ...
    private Vector2 GetPivot(PivotType type) => type switch
    {
        // => 代替 case:组合
        // _ 代替 default
    ...
    private float GetCost(DiscountInfo info, float originalPrice) => info switch
    {
    ...
    private float GetCost(string discount, bool isDiscount, float originalPrice) => (discount, isDiscount) switch
    {
    ...
    private float GetCost_Group(DiscountInfo info, float originalPrice) => info switch
    {
